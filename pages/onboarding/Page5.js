...
const Page5 = ({cData,setCData,bar,setBar}) => {
  ...
  return (
    <div className={styles.container5}>
              <form id='form1' className={styles.form1}>
                 ...
                 checked={cData?.checkbox5}
                 onChange={(e)=>{setCData({...cData,checkbox5:e.target.checked?true:false})}} 
                 onClick={handleChecbox} className={styles.checkbox1} type="checkbox"/>Ultimate Debtor</h2></div>
